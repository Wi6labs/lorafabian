...
#define STM32L053_CORE_ID 0xbc11477
...
#define STM32_CHIPID_L053_R8 0x417
...
static const chip_params_t devices[] = {
        ...
        {
            .chip_id = STM32_CHIPID_L053_R8,
                    .description = "L053R8",
                    .flash_size_reg = 0x1ff8007c,
                    .flash_pagesize = 0x80,
                    .sram_size = 0x2000, /*Not completely clear if there are some with 32K*/
                    .bootrom_base = 0x1ff00000,
                    .bootrom_size = 0x1000
        },
        {
