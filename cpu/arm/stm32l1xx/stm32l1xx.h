...
//acl redeclaration of C++ build in type bool
#ifndef __cplusplus
...
typedef struct
{
  ...
  __IO uint32_t dummy; 
  __IO uint32_t UI_H;   /*!< High UID reg,        Address offset: 0x14 */
} U_ID_TypeDef;
...
#ifdef STM32L1XX_MD
#define DEVICE_U_ID_BASE      ((uint32_t)0x1FF80050)
#else
#define DEVICE_U_ID_BASE      ((uint32_t)0x1FF800D0)
#endif
/**
  * @}
  */
...
/*******************  Bit definition for U_ID register  ***********************/
