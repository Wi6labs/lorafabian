...
//acl redeclartion of C++ build in typr bool
//typedef enum {FALSE = 0, TRUE = !FALSE} bool;
#define LOG_ASSERT
#ifdef LOG_ASSERT
...
//acl changes needed for DFU loader usage - otherwise no interrupt are generated
#ifdef USE_DFU_BOOTLD
#define FLASH_BASE            ((uint32_t)0x08005000) /*!< FLASH base address in the alias region */     
#else
...
#define DEVICE_U_ID_BASE      ((uint32_t)0x1FFFF7E8)
...
#define U_ID                ((U_ID_TypeDef *) DEVICE_U_ID_BASE)
/**
  * @}
  */
